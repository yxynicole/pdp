...
public class Book {
  ...
  public String toString() {
    return String.format("Title: %s Year: %d Price: %.2f", this.getTitle(), this.getYear(),
            this.getPrice());
  }
  ...
  public boolean equals(Object anotherBook) {
    ...
    return this.title.equals(((Book) anotherBook).getTitle()) && (this.year ==((Book)anotherBook).getYear());
  }
